...
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 1, 82020353229, 'Marianna', 'Konewka', 'Sprz¹taczka', 2500, '111222334', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 2, 82061365746, 'Zdzis³aw', 'Nowak', 'Konserwator', 2600, '543222333', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 2, 69100625638,  'Kornel', 'Tutaj', 'Pielêgniarz', 2800, '111753333', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 3, 72082757257, 'Joanna', 'Papaj', 'Pielêgniarka', 2800, '111222412', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 4, 79012333534, 'Kamil', 'Wakszmucki', 'Pielêgniarz', 2800, '111983333', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 10, 88062245348, 'Andrzej', 'Kolejarz', 'Ochroniarz', 2300, '532222333', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 10, 74051626245, 'Wac³aw', 'Tam', 'Ochroniarz', 2300, '111981333', 0);
...
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 3, 84100454185, 'Wasilij', 'Papataj', 'Pielêgniarz', 2800, '854222412', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 4, 70100973119, 'Antonina', 'Michalczyk', 'Pielêgniarka', 2800, '643983333', 0);
...
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 1, 84070986833, 'Wies³aw', 'M¹czka', 'Lekarz', 6800, '987983333', 0);
...
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 5, 70043085676, 'Micha³', 'RzeŸnik', 'Lekarz', 6800, '991786333', 0);
...
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 11, 76112152365, 'Dorbromi³a', 'Ogier', 'Lekarz', 6800, '991864999', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 5, 12334512376, 'Lena', 'Zielinska', 'Lekarz', 6500, '567103871', 0);
INSERT INTO pracownik VALUES (pracownik_id_seq.NEXTVAL, 6, 97645601295, 'Jakub', 'Wójcik', 'Lekarz', 4500,'567982341', 0);
...
INSERT INTO Pacjent VALUES (67061098799, 'Kacper', 'Ko³odziejczyk', TO_DATE('2018/12/19', 'yyyy/mm/dd'), '467086537');
...
INSERT INTO Pacjent VALUES (73082781622, 'Bogus³awa', 'Linda', TO_DATE('2018/02/14', 'yyyy/mm/dd'), '866685659');
...
INSERT INTO Pacjent VALUES (85062869592, 'Kacper', 'Korde³ka', TO_DATE('2016/09/11', 'yyyy/mm/dd'), '352856740');
INSERT INTO Pacjent VALUES (51101212652, 'Magda', 'Wressler', TO_DATE('2016/09/11', 'yyyy/mm/dd'), '777771216');

--Karta choroby
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 51101212652, 15, 6, TO_DATE('2016/09/11 17-41', 'yyyy/mm/dd HH24-MI'), TO_DATE('2016/09/11 19-41', 'yyyy/mm/dd HH24-MI'), 'Symulacja choroby', 'Dusznoœci, ból w klatce piersiowej');
...
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 87061092623, 10, 14, TO_DATE('2017/07/12 14-14', 'yyyy/mm/dd HH24-MI'), TO_DATE('2017/07/12 16-20', 'yyyy/mm/dd HH24-MI'), 'Nie stwierdzono choroby', 'Pacjentka twierdzi, ¿e ma wizje, ¿e umrze za 10 dni');
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 87061092623, 11, 19, TO_DATE('2017/07/22 13-34', 'yyyy/mm/dd HH24-MI'), TO_DATE('2017/07/22 17-34', 'yyyy/mm/dd HH24-MI'), 'Zgon', 'Brak przytomoœci, prawdopodobnie pêkniêty krwiak');
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 73082781622, 14, 1, TO_DATE('2018/02/14 11-10', 'yyyy/mm/dd HH24-MI'), TO_DATE('2018/02/15 11-10', 'yyyy/mm/dd HH24-MI'), 'St³uczenie', 'Silny ból lewego biodra');
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 84010867194, 7, 11, TO_DATE('2018/07/09 13-13', 'yyyy/mm/dd HH24-MI'), TO_DATE('2018/07/10 15-00', 'yyyy/mm/dd HH24-MI'), 'Z³amanie koœci lewej promieniowej', 'Z³amanie koœci lewej promieniowej');
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 72101999152,  6, 8, TO_DATE('2018/08/02 03-59', 'yyyy/mm/dd HH24-MI'), TO_DATE('2018/08/14 15-00', 'yyyy/mm/dd HH24-MI'), 'Zgon', 'Silny ból podczas oddychania i prze³ykania');
...
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 87030836913,  4, 6, TO_DATE('2019/01/01 12-41', 'yyyy/mm/dd HH24-MI'), NULL, NULL, 'Mocny ból g³owy, wysokie ciœnienie');
...
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 99122599541, 2, 2, TO_DATE('2019/01/08 18-20', 'yyyy/mm/dd HH24-MI'), NULL, NULL, 'Silny ból brzucha, czêste wymioty');
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 67061098799,  5, 7, TO_DATE('2018/12/19 07-21', 'yyyy/mm/dd HH24-MI'), NULL, NULL, 'Gor¹czka, silne bóle, agresja');
INSERT INTO karta_choroby VALUES (karta_id_seq.NEXTVAL, 51101212652, 15, 6, TO_DATE('2019/01/16 11-00', 'yyyy/mm/dd HH24-MI'), NULL, NULL, 'Dusznoœci, ból w klatce piersiowej');
...
INSERT INTO leki VALUES(lek_id_seq.NEXTVAL, 'Bepanthen Eye', ' ', 5, 'Jedno opakowanie blisko koñca daty przydatnœci');
